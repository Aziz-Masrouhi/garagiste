<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main" style="overflow-y: hidden;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('spareParts') || Request::is('spareParts/create') ? 'active' : '') }}" href="{{ route('spareParts.index') }}">
          ...
          <span class="nav-link-text ms-1">Spare Parts</span>
        </a>
      </li>
    </ul>
  </div>
