...
@section('content')
    ...
    <div class="col-12 mt-5">
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @foreach ($mecaniciens as $mecanicien)
                                    ...
                                    <!-- Edit Modal -->
                                    <div class="modal fade" id="editModal-{{ $mecanicien->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-title-notification" aria-hidden="true">
                                    ...
                                    <!-- Remove Modal -->
                                    <div class="modal fade" id="removeModal-{{ $mecanicien->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-title-notification" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ route('mecaniciens.destroy', $mecanicien->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-outline-danger btn-sm">Yes, remove it</button>
                                                    </form>
                                                    <button type="button" class="btn btn-outline-success btn-sm" data-bs-dismiss="modal">Cancel</button>
                                                </div>
                                            </div>
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="{{ route('mecaniciens.create') }}" class="btn btn-primary">+ Add new mecanicien</a>
            <a href="{{ route('mecaniciens.export') }}" class="btn btn-warning">Export Mecaniciens Data</a>
        </div>
    </div>
@endsection
